...
export { PluginService } from './lib/services/plugins.service';
export { Block, HeaderBlock, ImageBlock, ListBlock, ListStyle, ParagraphBlock } from './lib/types/blocks';
export { EditorJSConfig, HEADER_TOOL, LIST_TOOL, NgxEditorJSConfig, NGX_EDITORJS_CONFIG } from './lib/types/config';
